...
public class Exercise03 {
    public static void main(String[] args) {
        for (int z = 0; z <= 360; z = z + 15) {
            double rotZ = UtilAngle.radian(z);
            ...
            ConfigChessboard chessboard = new ConfigChessboard(4, 8, 20);


            // Render and display the simulation
            Se3_F64 truthMarkerToCamera = SpecialEuclideanOps_F64.eulerXYZ(-0.1, -PI, rotZ, 0, 0, 120, null);
            ...
            System.out.printf("Z rotation: %s\n", rotZ);
            ...
            double angleError = UtilAngle.degree(Math.abs(rod.theta));
            System.out.printf("Angle Error        %4.1f (deg)\n", angleError);
            if(angleError > 1){
                throw new RuntimeException("Angle error greater than 1");
            }
            ...
            double pixelError = EvaluatePerformance.averagePixelError(markerToCamera, pinhole, landmarks);
            System.out.println("Pixel error = " + pixelError);

...
public class Exercise04 {
    public static void main(String[] args) {
        ...
        a_to_camera.concat(b_to_camera.invert(null), a_to_b);
        ...
        Point3D_F64 X = new Point3D_F64(0, 0, 0); // Point in A's center
        ...
        b_to_camera.transform(X, X);
        // TODO Compute normalized image coordinate
        predicted.set(X.x / X.z, X.y / X.z);
        // TODO Render pixel coordinate with lens distortion (Don't use PerspectiveOps)
        distortion.distort_F64(false, true).compute(predicted.x, predicted.y, predicted);
